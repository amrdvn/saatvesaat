<template>
  ...
  <div class="header-minicart">
    <a
      ...
      class="skip-link skip-cart has-item skip-active"
    >
          ...
          <ul id="cart-sidebar" class="mini-products-list">
            <li class="item">
              <a
                ...
                class="product-image"
                ><img
                  src="https://cdn.saatvesaat.com.tr/mnresize/80/80/media/catalog/product/p/r/prgc505-01_1.jpg"
                  width="80"
                  height="80"
              ...
              <div class="product-details">
                ...
                <a
                  href="https://www.saatvesaat.com.tr/checkout/cart/ajaxDelete/id/4318820/uenc/aHR0cHM6Ly93d3cuc2FhdHZlc2FhdC5jb20udHIvY3VzdG9tZXIvYWNjb3VudC8,/"
                  title="Bu kaydı sil"
