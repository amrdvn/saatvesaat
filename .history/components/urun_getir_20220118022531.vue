...
export default {
  ...
  sepeteekle(){
    ...
    fbDb.ref('adet').set(sepetUrun);
    fbDb.ref('id').set(sepetUrun);
    fbDb.ref('image').set(sepetUrun);
    fbDb.ref('urunFiyat').set(sepetUrun);
    fbDb.ref('urunadi').set(sepetUrun);
    fbDb.ref('uruncode').set(sepetUrun);
  }
