      ...
      <div class="minicart-wrapper">
        ...
        <div>
          <ul  id="cart-sidebar" class="mini-products-list" >
            <li v-for="cart in inCart" :key="cart.id" :cart="cart" class="item">
              <a
                ...
                <table class="info-wrapper">
                  <tbody>
                    <tr>
                      <th>Fiyat</th>
                      <td>
                        <span class="price">{{cart.urunFiyat}}&nbsp;TL</span>
                      </td>
                    </tr>
        ...
        <div class="block-content">
          ...
          <p class="subtotal">
            ...
            <span class="price">{{total+=element.inCart.urunFiyat*element.inCart.adet}}&nbsp;TL</span>
          </p>
...
export default {
  ...
  sepetToplam(){
      ...
      this.inCart().forEach(element => {
          total+=element.inCart.urunFiyat*element.inCart.adet
      });
      return total
  },
