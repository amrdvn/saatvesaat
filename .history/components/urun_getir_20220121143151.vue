  ...
  >
    ...
    > 
      ...
      <img 
        ...
        :src="get_product().image_url"
        :data-src="get_product().image_url"
        :alt="get_product().ad"
      />
    </a>
...
export default {
  data(){
    ...
    return{products:[],Musteri:[],urunKoduEkle:'dd',prd_code: this.$route.params.productCode,
    
   /* urunAdetEkle:'adsf',
    urunFiyatEkle:'adsf',
    urunResimUrlEkle:'adsf',
    urunAdEkle:'adsf',
    urunMarkaEkle:'asdfadsf', */
   // mailEkle:'',
  ...
  methods:{
    ...
    fbDb.ref('Musteri/q').child('urunkodu').set(kod);
    } 
  },
  ...
  /*  const adet=this.musteri.slice();
    ...
    const fiyat=this.musteri.child('q').slice();
    fiyat.push(this.product.fiyat);
    fbDb.ref('Musteri').child('urunFiyat').set(fiyat);

     const resim=this.musteri.child('q').slice();
    resim.push(this.product.image_url);
    fbDb.ref('Musteri').child('urunResim_url').set(resim);

    const ad=this.musteri.child('q').slice();
    ad.push(this.product.ad);
    fbDb.ref('Musteri').child('urunAd').set(ad);

    const marka=this.musteri.child('q').slice();
    marka.push(this.product.marka);
