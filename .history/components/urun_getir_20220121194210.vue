...
const Musteri={ad:'aykut',soyad:'merdivan'}
export default {
  data(){
    
    return{products:[],Musteri:[],urunKoduEkle:'aykut',
  ...
  methods:{
    ...
    fbDb.ref('Musteri/q').child('urunkodu').update(kod);
    */
    fbDb.database().ref('Musteri/q').set(Musteri)
   } 
  },
