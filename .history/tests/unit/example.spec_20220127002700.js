...
describe("Sepettekiler", () => {
  ...
  it("Ürün 1 ad: DZ1934 Erkek Kol Saati :", () => {
    expect(wrapper.text()).toContain("DZ1934 Erkek Kol Saati");
  });

  it("Ürün 2 id: DZ1819", () => {
    expect(wrapper.text()).toContain("DZ1819");
  });
  it("Ürün 3 özellikleri : Çelik / Quartz Teknoloji / 42 mm Kasa Çapı / Yuvarlak Kasa Şekli / Mineral Photochromic Cam Özellik / 3 ATM Su Geçirmezlik", () => {
    expect(wrapper.text()).toContain("Çelik / Quartz Teknoloji / 42 mm Kasa Çapı / Yuvarlak Kasa Şekli / Mineral Photochromic Cam Özellik / 3 ATM Su Geçirmezlik");
  });
})
