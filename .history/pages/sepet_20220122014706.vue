                  ...
                  <td colspan="50" class="text=left cart-footer-actions">
                    <div class="col-xs-6 pl0">
                      ...
                      <button
                        ...
                        onclick="setLocation('https://www.saatvesaat.com.tr/saat/bayan')"
                      >
...
export default {
  data() {
    return { products: [], user: '', sepet : [],Musteri:[]
     }
  },
  mounted() {
    fbDb
      .ref('Musteri/'+this.user.uid)
      .get()
      .then((snapshot) => {
        if (snapshot.exists()) {
          this.Musteri = snapshot.val()
