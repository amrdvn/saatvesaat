        ...
        <div class="cart display-single-price">
          ...
          >
            ...
            <table id="shopping-cart-table" class="cart-table data-table">
              ...
              <tbody>
                <tr v-for="pos in Sepet.length">
                  <td :key="pos" class="product-cart-image">
                    <a
                ...
                <tfoot>
                  <tr class="mnm-grand-total">
                    ...
                    <td style="" class="a-right">
                      <strong><span class="price">{{fnc(toplamTutar())}}&nbsp;TL</span></strong>
                    </td>
                  </tr>
                </tfoot>
                <tbody>
                  <tr class="mnm-sub-total">
                    ...
                    <td style="" class="a-right">
                      <span class="price">{{fnc(toplamTutar())}}&nbsp;TL</span>
                    </td>
                  </tr>
